            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-1">
                        {powers.slice(0, 2).map(item => <Badge key={item} variant="outline" className="text-xs">{item}</Badge>)}
                        {powers.length > 2 && <Badge variant="outline" className="text-xs bg-gray-100">
